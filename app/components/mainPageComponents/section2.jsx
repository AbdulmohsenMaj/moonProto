	...
	const categories = [
		{
			id: 1,
			name: "SHIRTS",
			image: "/landing/images/section2/shirt.png",
			description: "Description for SHIRTS",
		},
		{
			id: 2,
			name: "DENIM",
			image: "/landing/images/section2/denim.png",
			description: "Description for DENIM",
		},
		{
			id: 3,
			name: "TEES",
			image: "/landing/images/section2/tee.png",
			description: "Description for TEES",
		},
		{
			id: 4,
			name: "PANTS",
			image: "/landing/images/section2/pants.png",
			description: "Description for PANTS",
		},
		{
			id: 5,
			name: "SWEATERS",
			image: "/landing/images/section2/sweater.png",
			description: "Description for SWEATERS",
		},
		{
			id: 6,
			name: "OUTERWEAR",
			image: "/landing/images/section2/outerwear.png",
