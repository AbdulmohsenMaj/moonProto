	...
	return (
		<div className="navbar bg-base-100 shadow-sm border-b border-[#DDDBDC] min-h-[56px] px-2 sm:px-4">
			<div className="navbar-start">
                        ...
                        {navItems.map((item) => (
                            <li key={item.label}>
                                <motion.a
                                    ...
                                    className="w-full px-[12px] py-[12px] flex items-center justify-start"
                                >
                                    <p className="h-[16px] whitespace-nowrap">{item.label}</p>
                                </motion.a>
                            </li>
                        ))}
                    </ul>
				...
				<div className="hidden lg:flex w-auto h-[56px]">
                        ...
                        {navItems.map((item) => (
                            <li key={item.label}>
                                <motion.a
                                    ...
                                    className={`h-[56px] px-[12px] py-[20px] flex items-center justify-center whitespace-nowrap ${
                                        item.active
                                            ? "text-black underline underline-offset-[21px] decoration-[3px]"
                                            : ""
                                    }`}
                                >
                                    <p className="h-[16px]">{item.label}</p>
                                </motion.a>
                            </li>
                        ))}
                    </ul>
