...
// Carbon copy ProviderButton from previous implementation
...
export default function SignupPage() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      setErrors({ submit: `Network error: ${error.message}. Please try again.` });
    } finally {
      setIsLoading(false);
    }
  }
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-2">Sign up with email or social provider</p>
          </div>
          ...
          <div className="space-y-3">
            <Suspense>
              <ProviderButton provider="google">Sign up with Google</ProviderButton>
            </Suspense>
            <Suspense>
